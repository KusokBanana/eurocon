    ...
    public function bootstrap($app)
    {
        if ($app instanceof Web) {
            $app->getUrlManager()->addRules([
                'messages/<contactId:\d+>' => $this->id . '/message/page',
                'messages' => $this->id . '/message/page',
                'render-view' => '/message/render-view',
                'login-as/<userId:\d+>' => $this->id . '/message/login-as',
                'chat/get/messages/<contactId:\d+>' => $this->id . '/message/messages',
                'chat/get/conversations' => $this->id . '/message/conversations',
                'chat/delete/message/<id:\d+>' => $this->id . '/message/delete-message',
                'chat/delete/conversation/<contactId:\d+>' => $this->id . '/message/delete-conversation',
...
//            $app->getView()->renderers['twig']['globals']['html'] = '\yii\helpers\Html';
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'frontend\modules\chat\console\MessageController',
                'module' => $this,
            ];
        }
    }
